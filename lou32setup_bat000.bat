...
echo -- Hibbiki.Chromium Mozilla.Firefox 7zip.7zip TGRMNSoftware.BulkRenameUtility Ghisler.TotalCommander Microsoft.NuGet Microsoft.Sysinternals.ProcessMonitor Microsoft.VCRedist.2015+.x64 Microsoft.WindowsTerminal Audacity.Audacity PeterPawlowski.foobar2000 Mozilla.Thunderbird ShareX.ShareX SumatraPDF.SumatraPDF Microsoft.DotNet.Framework.DeveloperPack_4 Microsoft.DotNet.DesktopRuntime.8 Notepad++.Notepad++ Python.Python.3.10 Microsoft.VisualStudioCode Microsoft.VisualStudio.2022.Community
taskkill /f /im explorer.exe && start explorer.exe && start cmd /k "winget install Hibbiki.Chromium Mozilla.Firefox 7zip.7zip TGRMNSoftware.BulkRenameUtility Ghisler.TotalCommander Microsoft.NuGet Microsoft.Sysinternals.ProcessMonitor Microsoft.VCRedist.2015+.x64 Microsoft.WindowsTerminal Audacity.Audacity PeterPawlowski.foobar2000 Mozilla.Thunderbird ShareX.ShareX SumatraPDF.SumatraPDF Microsoft.DotNet.Framework.DeveloperPack_4 Microsoft.DotNet.DesktopRuntime.8 Notepad++.Notepad++ Python.Python.3.10 Microsoft.VisualStudioCode Microsoft.VisualStudio.2022.Community --accept-source-agreements --accept-package-agreements --force"
:: Pause the script
pause
